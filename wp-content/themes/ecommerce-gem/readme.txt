...
= 2.1.7 =
* Security Fixes
* Navbar menu-item active and hover set bottom pattern
* Hero Slider indicator shape change and active indicator size increase
* Social media btn and back to top button rounded
